...
open class Chart: UIControl {
    ...
    /**
     Return the y value for the specified series at the given index.
     */
    open func valueForSeriesX(_ seriesIndex: Int, atIndex dataIndex: Int?) -> Double? {
        if dataIndex == nil { return nil }
        let series = self.series[seriesIndex] as ChartSeries
        return series.data[dataIndex!].x
    }
    ...
    /**
     Return the y value for the specified series at the given index.
     */
    open func valueForSeriesY(_ seriesIndex: Int, atIndex dataIndex: Int?) -> Double? {
        if dataIndex == nil { return nil }
        let series = self.series[seriesIndex] as ChartSeries
